...
- Download the Visual Studio Code installer for Windows/Mac/Linux. Once it is downloaded, run the installer. 

- After accepting all the requests, press the finish button.

- Open the  Visual Studio Code to verify the installation.