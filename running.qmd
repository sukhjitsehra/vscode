...
We will use a custom.template to  add documentation to your program. Download the [custom template](custom.mustache) and follow the steps to add it to VS code. 
